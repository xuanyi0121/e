...
async def yv_lu(bot: Client, message: Message):
    ...
    for num in range(1, 5):
        if not exists('plugins/yvlu/p' + str(num) + '.png'):
            re = get('https://github.com/FoKit/PagerMaid_Plugins/raw/modify/yvlu/p' + str(num) + '.png')
    ...
    if not exists('plugins/yvlu/SourceHanSans-Normal.ttc'):
        ...
        re = get('https://github.com/FoKit/PagerMaid_Plugins/raw/modify/yvlu/SourceHanSans-Normal.ttc')
